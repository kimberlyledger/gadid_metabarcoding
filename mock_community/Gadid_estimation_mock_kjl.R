...
#### the goal of this code is to use mock communities of gadids to improve estimates of sequencing proportions ##### 
...
#save(Output,file=paste0("/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S1_mock_E_N1_S1",".Rdata"))
#save(Output,file=paste0("/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S2_mock_E_N1_S1",".Rdata"))
#save(Output,file=paste0("/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S3_mock_E_N1_S1",".Rdata"))
#save(Output,file=paste0("/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S4_mock_E_N1_S1",".Rdata"))
save(Output,file=paste0("/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S5_mock_E_N1_S1",".Rdata"))
...
#ggsave(p9, filename = "/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S1_mock.pdf", width = 7, height = 5, units = "in")
#ggsave(p9, filename = "/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S2_mock.pdf", width = 7, height = 5, units = "in")
#ggsave(p9, filename = "/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S3_mock.pdf", width = 7, height = 5, units = "in")
#ggsave(p9, filename = "/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S4_mock.pdf", width = 7, height = 5, units = "in")
ggsave(p9, filename = "/home/kimberly.ledger/eDNA_metabarcoding/gadid_20220111/gadid_S5_mock.pdf", width = 7, height = 5, units = "in")
